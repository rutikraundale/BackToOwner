...
const SearchItem = () => {
  return (
    <div className='flex w-full h-auto overflow-auto justify-center items-center'>
      <header className="w-full flex flex-col h-auto  md:flex-wrap justify-center  text-center items-center">
        <div
          className=" w-full  bg-[#0f0a1e] h-auto  rounded-3xl flex justify-center items-center flex-col flex-wrap md:w-[890px]  border border-white backdrop-blur-sm ">
          <div>
